...
<div id="bg">
	...
	<body>
		<%
			...
			//Prevent user to get back by pressing back when logged out(without writing in email and password)
			...
			<form action="StudentControllerServlet" method="GET">
				...
				<table>
					<tbody>
								...
								<!-- Pass id parameter to know which student is to be added a new semester -->
						<tr>
						...
						<tr>
							<td><label></label></td>			<!-- Prompt the user before adding a semester -->
							<td><input type="submit" value="Save" class="save"
								onclick="if(!(confirm('Make sure that marks you wrote in are correct')))return false"></td>
						</tr>
